...
if st.session_state.show_intro:
    ...
    st.write("- Try to beat your own record or compete with friends!")
    st.write("Get ready to test your speed and reflexes!")
...
if st.session_state.game_started and not st.session_state.game_over:
    ...
    st.experimental_rerun() if time_left > 0 else None
